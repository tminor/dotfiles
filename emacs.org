...
** Makefile
:PROPERTIES:
:HASH:     efe9a9e5be26fc93e5ed9805e739d80e
:MODIFIED: [2021-07-12 Mon 15:12]
...
SPEED = bash -c 'time emacs -L . -l init --batch --eval "(message \"Hello, world!\")"'
TEST  = bash -c 'cask install; cask exec sh -c "buttercup -L . tests -l init"'
...
.PHONY: speed
speed: docker ## Start Emacs and report how long it takes to initialize
	$(DOCKER) $(RUN) $(SPEED)
...
** Cask File
:PROPERTIES:
:HASH:     95ee6c65c6c19ac96f0483582644a88a
:MODIFIED: [2021-07-12 Mon 14:50]
:header-args+: :tangle .emacs.d/Cask
:END:
...
** Initialization
:PROPERTIES:
:HASH:     f772b297ba56ecfedcbd4cae93f83d6a
:MODIFIED: [2021-07-12 Mon 14:09]
